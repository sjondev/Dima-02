...
public class ReportHandler(IHttpClientFactory httpClientFactory) : IReportsHandler
{
    ...
    public Task<Response<List<ExpensesByCategory>?>> GetExpensesByCategoryRequestAsync(GetExpensesByCategoryRequest request)
    {
